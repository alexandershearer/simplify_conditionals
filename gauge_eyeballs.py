...
fit_eye_size = eye_size > 0.45
fit_iris_area = (math.pi*iris_width/2*iris_height/2) / eye_size >= 0.69
fit_eye_ratio = eye_height/eye_width >= 0.59

if fit_eye_size and fit_iris_area and fit_eye_ratio:
